...
export function SosAlertDetail({
  ...
  async function handleStatusUpdate() {
    if (mode !== "teacher" || next === undefined) return;
    setIsUpdating(true);
    setError(null);
    ...
    try {
      ...
      setError("Chưa cập nhật được trạng thái. Hãy thử lại.");
    } finally {
      setIsUpdating(false);
    }
  }
  ...
  return (
    <main className="mx-auto max-w-[960px] space-y-6">
      ...
      {/* Status and severity */}
      <section className="rounded-2xl border border-outline-variant bg-white dark:bg-[#1a2244] p-6 shadow-sm">
