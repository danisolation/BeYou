...
const coreValues = [
  {
    ...
    description:
      "Dữ liệu được mã hóa, không ai ngoài bạn có thể đọc nhật ký hay lịch sử trò chuyện.",
  },
  {
    icon: Brain,
    title: "Hỗ trợ từ chuyên gia",
    description:
      "Nội dung và kịch bản được xây dựng bởi chuyên gia tâm lý học đường Việt Nam.",
  },
  {
    icon: Heart,
    title: "Luyện tập kỹ năng sống",
    description:
      "Thực hành xử lý tình huống thực tế, rèn luyện cách quản lý cảm xúc hàng ngày.",
  },
];
    ...
    <main className="min-h-dvh overflow-x-hidden bg-background">
      ...
      <header className="sticky top-0 z-50 border-b border-outline-variant/20 bg-white/90 backdrop-blur-lg dark:bg-[#0f1530]/90">
        <nav className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link
            href="/"
            className="flex items-center gap-2 text-sm font-semibold font-bold text-primary no-underline"
          >
          ...
          <div className="hidden items-center gap-6 md:flex">
            <a
              href="#mission"
              className="text-sm text-on-background/70 no-underline hover:text-primary"
            >
              Sứ mệnh
            </a>
            <a
      ...
      <section className="relative overflow-hidden px-5 py-16 lg:px-16 lg:py-24">
        ...
        />
        <div
          className="pointer-events-none absolute -bottom-16 -right-16 h-72 w-72 rounded-full bg-tertiary/5 blur-3xl"
          aria-hidden="true"
        />
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="animate-fade-in">
            ...
            <p className="mt-4 max-w-xl text-base text-on-background/70">
              Dành cho học sinh THPT muốn hiểu cảm xúc của mình, tập cách xử lý
              những tình huống khó, và tìm đến người lớn em tin khi cần.
            </p>
      ...
      <section
        id="mission"
        className="bg-white dark:bg-[#1e2d40] px-5 py-16 lg:px-16 lg:py-20"
      >
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-2xl text-on-background">
            Peerlight AI là nơi an toàn để em được lắng nghe, được tôn trọng và
      ...
      <section className="px-5 py-16 lg:px-16 lg:py-20">
        <div className="mx-auto max-w-7xl">
          <h2 className="text-center text-2xl text-on-background">
            Giá trị cốt lõi
          </h2>
            ...
            {coreValues.map((value, index) => (
              <ScrollReveal key={value.title} delay={index * 100}>
                <div className="card-lift rounded-2xl bg-white dark:bg-[#1e2d40] p-6 ring-1 ring-outline-variant/20 transition-shadow hover:shadow-md">
                  ...
                  <h3 className="mt-4 text-lg text-on-background">
                    {value.title}
                  </h3>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2 md:grid-cols-12">
            ...
            <ScrollReveal className="sm:col-span-2 md:col-span-8">
              <div className="card-lift rounded-2xl bg-primary/10 p-6 sm:p-8">
                ...
                <p className="mt-2 max-w-lg text-sm text-on-background/70">
                  Trò chuyện với AI biết lắng nghe, không phán xét, và gợi ý
                  bước tiếp theo khi em cần.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal className="sm:col-span-1 md:col-span-4" delay={200}>
              <div className="card-lift rounded-2xl bg-error-container p-6">
                ...
                <p className="mt-2 text-sm text-on-background/70">
                  Gửi tín hiệu khẩn cấp đến người lớn tin tưởng chỉ trong một
                  bước.
                </p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal className="sm:col-span-2 md:col-span-8" delay={300}>
              <div className="card-lift rounded-2xl bg-white p-6 sm:p-8 dark:bg-[#1a2244]">
                ...
                <h3 className="mt-4 text-lg text-on-background">
                  Riêng tư của em luôn được tôn trọng
                </h3>
                <p className="mt-2 max-w-lg text-sm text-on-background/70">
                  Dữ liệu của bạn thuộc về bạn. Không ai có thể đọc nhật ký hay
                  trò chuyện mà không có sự đồng ý.
                </p>
              </div>
            </ScrollReveal>
          </div>
          ...
          <div className="card-lift rounded-2xl bg-white/80 p-8 shadow-lg ring-1 ring-outline-variant/20 backdrop-blur lg:p-12">
            ...
            <ul className="mt-6 space-y-3">
              {privacyFeatures.map((feature) => (
                <li
                  key={feature}
                  className="flex items-start gap-3 text-base text-on-background/80"
                >
                  <Shield
        ...
        <section className="bg-primary px-5 py-16 lg:px-16 lg:py-20">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-2xl text-on-primary">
              Bắt đầu từ một bước nhỏ, khi em sẵn sàng
            </h2>
            <p className="mt-4 text-base text-on-primary/80">
              Chỉ cần vài bước đơn giản, bạn đã có một không gian an toàn để
              chia sẻ và được hỗ trợ.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div>
            ...
            <p className="mt-3 text-sm text-on-background/60">
              Nơi em có thể dừng lại, thở sâu và được lắng nghe. Đồng hành cùng
              học sinh THPT và gia đình trên hành trình chăm sóc sức khỏe tinh
              thần.
            </p>
          </div>
          <div>
            <h4 className="text-xs-md font-semibold text-on-background">
              Về chúng tôi
            </h4>
            <ul className="mt-3 space-y-2 text-sm text-on-background/60">
              <li>
                <a href="#mission" className="no-underline hover:text-primary">
                  Sứ mệnh
                </a>
              </li>
              <li>
                <a href="#features" className="no-underline hover:text-primary">
                  Tính năng
                </a>
              </li>
              <li>
                <a href="#support" className="no-underline hover:text-primary">
                  Hỗ trợ
                </a>
              </li>
            </ul>
