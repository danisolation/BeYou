...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "in_app_reminders_enabled", sa.Boolean(), nullable=False, server_default=sa.false()
        ),
        sa.Column(
            "mood_checkin_reminders_enabled",
            sa.Boolean(),
            nullable=False,
            server_default=sa.false(),
        ),
        sa.Column(
            "reminder_cadence", sa.String(length=32), nullable=False, server_default="weekly"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "reminder_type", sa.String(length=64), nullable=False, server_default="mood_check_in"
        ),
    ...
    op.create_index(
        "ix_mood_checkin_reminder_states_student_id", "mood_checkin_reminder_states", ["student_id"]
    )
    op.create_index(
        "ix_mood_checkin_reminder_states_due", "mood_checkin_reminder_states", ["next_due_at"]
    )
    op.create_index(
        "ix_mood_checkin_reminder_states_is_demo", "mood_checkin_reminder_states", ["is_demo"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "revoked_by_id", postgresql.UUID(as_uuid=True), sa.ForeignKey("users.id"), nullable=True
        ),
    )
    ...
    op.create_index(
        "ix_mood_note_shares_student_created", "mood_note_shares", ["student_id", "created_at"]
    )
    op.create_index(
        "ix_mood_note_shares_adult_created", "mood_note_shares", ["adult_id", "created_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "default_in_app_reminders_enabled",
            sa.Boolean(),
            nullable=False,
            server_default=sa.false(),
        ),
        ...
        sa.Column("allowed_channels", postgresql.JSONB(astext_type=sa.Text()), nullable=False),
        sa.Column(
            "external_channels_enabled", sa.Boolean(), nullable=False, server_default=sa.false()
        ),
        sa.Column("note_sharing_enabled", sa.Boolean(), nullable=False, server_default=sa.true()),
        sa.Column(
            "reason_required_for_adult_summaries",
            sa.Boolean(),
            nullable=False,
            server_default=sa.true(),
        ),
        sa.Column(
            "reason_required_for_shared_mood_notes",
            sa.Boolean(),
            nullable=False,
            server_default=sa.true(),
        ),
    ...
    op.create_index(
        "ix_school_privacy_policy_defaults_is_demo", "school_privacy_policy_defaults", ["is_demo"]
    )
    op.create_index(
        "ix_school_privacy_policy_defaults_updated",
        "school_privacy_policy_defaults",
        ["updated_at"],
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_school_privacy_policy_defaults_updated", table_name="school_privacy_policy_defaults"
    )
    op.drop_index(
        "ix_school_privacy_policy_defaults_is_demo", table_name="school_privacy_policy_defaults"
    )
    ...
    op.drop_index(
        "ix_mood_checkin_reminder_states_is_demo", table_name="mood_checkin_reminder_states"
    )
    op.drop_index("ix_mood_checkin_reminder_states_due", table_name="mood_checkin_reminder_states")
    op.drop_index(
        "ix_mood_checkin_reminder_states_student_id", table_name="mood_checkin_reminder_states"
    )
    op.drop_table("mood_checkin_reminder_states")

    op.drop_index(
        "ix_student_notification_preferences_paused_until",
        table_name="student_notification_preferences",
    )
    op.drop_index(
        "ix_student_notification_preferences_is_demo", table_name="student_notification_preferences"
    )
    op.drop_index(
        "ix_student_notification_preferences_student_id",
        table_name="student_notification_preferences",
